...
import com.asrulsibaoel.lectureme.presenter.loader.PresenterLoader;
import com.asrulsibaoel.lectureme.injection.AppComponent;
import com.asrulsibaoel.lectureme.presenter.BasePresenter;
...
public abstract class BaseFragment<P extends BasePresenter<V>, V> extends Fragment implements LoaderManager.LoaderCallbacks<P> {
    ...
    private void injectDependencies() {
        setupComponent(((LectureMe) getActivity().getApplication()).getAppComponent());
    }
