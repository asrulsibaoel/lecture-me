...
public final class LecturerLoginPresenterImpl extends BasePresenterImpl<LecturerLoginView> implements LecturerLoginPresenter {
    /**
     * The interactor
     */
    @NonNull
    private final LecturerLoginInteractor mInteractor;
    ...
    @Inject
    public LecturerLoginPresenterImpl(@NonNull LecturerLoginInteractor interactor) {
